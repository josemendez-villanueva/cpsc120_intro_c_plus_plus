...
// Lab 11-01
//
// Made a program to make a sky image with a sphere in the middle of it.
//
...
Color RayColor(const Ray& r, const Sphere& world) {
  ...
  if (world.hit(r, 0, kInfinity, rec)) {
    ...
    // set up the vectors need, see the README.md
    Vec3 light{1, 1, 0.25};
    ...
    // Calculate phong_ambient, phong_diffuse, and phong_specular
    ...
    Color phong_specular = kSpecularReflection *
    ...
    Color sky_top{0.5, 0.7, 0.9};
    Color sky_bottom{1.0, 1.0, 1.0};
