...
// Lab 07-01
//
// Made a program to use a vector to find the minimum value
//
...
void PrintVector(const vector<int>& the_vector) {
  // print out each element in the vector using an
...
void FillVector(vector<int>& the_vector, const int nelements,
  ...
  // Make sure you can read and understand this code! Be able
...
int FindMinimum(vector<int>& the_vector) {
  // return the minimum value of the vector using min_element() and
  // distance()
  int min = -42;
